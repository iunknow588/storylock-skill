...
const requiredEntries = [
  ...
  'identity-package/templates/login-sites.json',
  'identity-package/templates/signing-actions.json',
  'identity-package/templates/agent-tasks.json',
  'identity-package/story-drafts/manifest.json',
