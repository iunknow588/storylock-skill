...
const requiredFiles = [
  ...
  'src/host/android-host/app/src/main/assets/story-drafts/zhizi-yilin-zh.json',
  'src/host/android-host/app/src/main/assets/story-drafts/emperor-new-clothes-en.json',
