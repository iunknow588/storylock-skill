  ...
  resources: [
    {
      ...
      bindings: [
        {
          role: "username",
          objectId: "credential/generic/main/username",
        },
        {
          role: "password",
          objectId: "credential/generic/main/password",
        },
      ],
    },
    {
      ...
      bindings: [
        {
          role: "private_key",
          objectId: "wallet/ethereum/main/private_key",
        },
        {
          role: "keystore_password",
          objectId: "wallet/ethereum/main/keystore_password",
        },
      ],
    },
  ],
...
async function main() {
  ...
  console.log("StoryLock skill-engine demo succeeded.");
  console.log(
    JSON.stringify(
      {
        passwordFill,
...
main().catch((error) => {
  console.error("StoryLock skill-engine demo failed.");
  console.error(error);
  process.exitCode = 1;
});
